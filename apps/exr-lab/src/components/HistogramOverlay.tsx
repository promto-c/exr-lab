...
export const HistogramOverlay: React.FC<HistogramOverlayProps> = ({ data, onClose }) => {
  ...
  return (
    <div
      data-touch-ui="true"
      className="absolute bottom-4 right-4 bg-neutral-900/40 border border-neutral-800 p-4 rounded-lg shadow-xl backdrop-blur-sm w-64 animate-in fade-in slide-in-from-bottom-2 z-20"
    >
