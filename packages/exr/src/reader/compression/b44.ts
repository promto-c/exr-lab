...
function unpack14(source: Uint8Array, offset: number, out: Uint16Array) {
  ...
  out[4] =
    (out[0] +
      (((((source[offset + 2] << 4) | (source[offset + 3] >> 4)) & 0x3f) << shift) - bias)) &
    0xffff;
  out[8] =
    (out[4] +
      (((((source[offset + 3] << 2) | (source[offset + 4] >> 6)) & 0x3f) << shift) - bias)) &
    0xffff;
  ...
  out[5] =
    (out[4] +
      (((((source[offset + 5] << 4) | (source[offset + 6] >> 4)) & 0x3f) << shift) - bias)) &
    0xffff;
  out[9] =
    (out[8] +
      (((((source[offset + 6] << 2) | (source[offset + 7] >> 6)) & 0x3f) << shift) - bias)) &
    0xffff;
  ...
  out[6] =
    (out[5] +
      (((((source[offset + 8] << 4) | (source[offset + 9] >> 4)) & 0x3f) << shift) - bias)) &
    0xffff;
  out[10] =
    (out[9] +
      (((((source[offset + 9] << 2) | (source[offset + 10] >> 6)) & 0x3f) << shift) - bias)) &
    0xffff;
  ...
  out[7] =
    (out[6] +
      (((((source[offset + 11] << 4) | (source[offset + 12] >> 4)) & 0x3f) << shift) - bias)) &
    0xffff;
  out[11] =
    (out[10] +
      (((((source[offset + 12] << 2) | (source[offset + 13] >> 6)) & 0x3f) << shift) - bias)) &
    0xffff;
